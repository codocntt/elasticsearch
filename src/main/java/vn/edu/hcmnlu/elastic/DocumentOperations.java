...
public class DocumentOperations {
	...
	public void updateDocument(Client client, String index, String type, Student p){
	...
	public Student getDocument(Client client, String index, String type, String id){
